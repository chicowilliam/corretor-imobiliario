...
export function AdvisorIntro({ agent }: { agent: Agent }) {
  return <section id="sobre" className="shell section-space" aria-labelledby="advisor-heading"><div className="advisor-layout">
    <figure><DepthReveal className="advisor-photo"><Image src={agent.photo.src} alt={agent.photo.alt} fill loading="lazy" sizes="(max-width: 767px) 90vw, (max-width: 1400px) 42vw, 580px" /></DepthReveal><figcaption className="mt-4 text-[9px] tracking-wide text-muted">Fotografia ilustrativa · Perfil demonstrativo</figcaption></figure>
    <div className="advisor-composition"><Reveal><h2 id="advisor-heading" className="display section-title">Imóveis são sobre<br />pessoas.</h2></Reveal>
