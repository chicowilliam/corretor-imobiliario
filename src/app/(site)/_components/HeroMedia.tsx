...
export function HeroMedia({ imageSrc, imageAlt, videoSrc, objectPosition = "center 58%" }: HeroMediaProps) {
  ...
  return videoSrc
    ...
    : <div className="hero-media" data-hero-media><div className="hero-pointer-layer"><div className="hero-focus-layer">{poster}<div className="hero-soft-veil" aria-hidden="true" /></div></div></div>;
}
