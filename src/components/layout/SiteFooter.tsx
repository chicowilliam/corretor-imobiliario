...
export function SiteFooter() {
  return <footer id="contato" className="shell">
    <div className="footer-top">
      ...
      <Reveal className="footer-conversation"><h2 className="display text-[32px]">Toda boa escolha começa<br />com uma conversa.</h2><ContactCTA className="text-link mt-4" message="Olá, Tomás! Gostaria de conversar sobre imóveis em Belo Horizonte.">Vamos conversar</ContactCTA></Reveal>
